...
if($db) {
	...
	$opens_query = "SELECT Open_Cnt, Mailing_Nm, Start_Ts 
					FROM `sm_mailing_summary` 
					WHERE From_Nm LIKE '$campaign' AND Open_Cnt IS NOT NULL AND Mailing_Nm IS NOT NULL AND Start_Ts IS NOT NULL 
					ORDER BY Start_Ts";
